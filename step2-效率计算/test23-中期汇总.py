...
def test23():
    ...
    test23_data_index = pda.read_excel(rootPath  + '/test23_data_index.xlsx')
    test15_result_data = pda.read_excel(rootPath  + '/test23-test15_result_info_flag1.xlsx')
    test23_data_index.set_index('新文件序号',drop=True,inplace=True)

    test15_result_data = test15_result_data[test15_result_data['半径是否可行'] >=0]

    for i in test15_result_data.index :
    ...
    test23_data_index.to_excel(rootPath + '/test23_data_index_flag = 1.xlsx')
